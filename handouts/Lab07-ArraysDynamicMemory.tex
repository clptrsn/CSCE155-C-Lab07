...
the following URL: \url{https://github.com/clptrsn/CSCE155-C-Lab07}.
...
\begin{enumerate}
  ...
  \item Hand in your \mintinline{text}{stats.c}, \mintinline{text}{stats.h}, and \mintinline{text}{statsMain.c} source file by pointing your browser to:
